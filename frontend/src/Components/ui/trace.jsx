...
export const TracingBeam = ({
  ...
  const y1 = useSpring(
    useTransform(scrollYProgress, [0, 0.8], [50, svgHeight * (activeSection + 1)]),
    { stiffness: 500, damping: 90 }
  );

  const y2 = useSpring(
    useTransform(scrollYProgress, [0, 1], [50, svgHeight * (activeSection + 1) - 200]),
    { stiffness: 500, damping: 90 }
  );
  ...
  return (
    ...
    >
      ...
      <div ref={contentRef} className="section">{children}</div>
    </motion.div>
  );
};